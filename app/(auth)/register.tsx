    ...
    return (
      <View className="flex-1 items-center justify-center dark:bg-black bg-white">
        <Text className="text-gray-600">
          Postopek lahko traja nekaj minut zato prosim počakajte.
        </Text>
        <ActivityIndicator
          size="large"
  ...
  return (
    ...
    >
      <View className="flex flex-1 justify-center items-center  bg-white dark:bg-black">
        ...
        >
          <Text className="text-lg text-white dark:text-black ">
            {" "}
            Registracija{" "}
          </Text>
        </Pressable>
        ...
        {cameraOpen && cameraPermission && (
          ...
          >
            ...
            >
              ...
              <View
                className={`mx-auto my-auto w-[80%] h-[55%] border-8  rounded-full bg-transparent ${recording ? "border-red-500" : "border-white"}`}
              />
