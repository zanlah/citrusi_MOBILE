    ...
    return (
        <ScrollView className="bg-gray-100 min-h-full pt-5 px-3 pb-10">
            ...
            <View className="p-2 bg-white rounded-2xl flex justify-center items-center mt-1">
                <Image className="rounded-full aspect-square w-full h-40 bg-contain" source={{ uri: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTSLU5_eUUGBfxfxRd4IquPiEwLbt4E_6RYMw&s' }} />
