  ...
  return (
    <>
      <ScrollView className="bg-gray-100 dark:bg-black min-h-full pt-5 px-3 pb-10">
        ...
        <Pressable
          className="p-2 bg-white dark:bg-zinc-900 rounded-2xl flex justify-center items-center mt-1"
          onPress={selectNewProfileImage}
        >
          <Image
            className="rounded-full aspect-square w-full h-40 bg-contain"
            src={`${process.env.EXPO_PUBLIC_API_URL}/uploads/profileImages/${profileImage}`}
          />
        ...
        <View className="mt-5 ">
          ...
          <View className="rounded-2xl bg-white dark:bg-zinc-900 mt-1">
            <View className="p-2 mt-1 flex justify-between  flex-row ">
              <Text className="text-lg text-gray-600  dark:text-white flex-auto">
                Dodaj prijatelja
              </Text>
        ...
        <View className="mt-5 mb-10">
          <Pressable
            className="p-2 mt-1 dark:bg-zinc-900 bg-gray-200 rounded-2xl flex justify-center items-center "
            onPress={signOut}
          >
